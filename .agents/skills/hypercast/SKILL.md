...
_Originally published at [hyperbliss.tech](https://hyperbliss.tech/blog/{slug}/). Follow me on [GitHub](https://github.com/hyperb1iss) and [Bluesky](https://bsky.app/profile/hyperbliss.tech)._
```
...
```bash
bash .Codex/skills/hypercast/scripts/publish.sh <slug>
```
