...
excerpt:
  'HyperShell: a terminal setup that bridges Windows and Linux through WSL2,
...
**HyperShell** is a terminal setup that bridges Windows and Linux. If you love
Linux's flexibility but still use Windows for specific workloads, HyperShell
gives you one cohesive environment across both.
...
AstroNvim is my go-to Neovim configuration. Feature-rich out of the box without
much hassle.
...
HyperShell bridges Windows and Linux into one flexible terminal environment for
developers, sysadmins, and creatives who work across both.

Check out the [GitHub repository](https://github.com/hyperb1iss/dotfiles) and
give it a try. Open an issue or share your thoughts!
