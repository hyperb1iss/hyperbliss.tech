...
export class CollisionHandler {
  ...
  private static octree: Octree<VectorShape> | null = null
  ...
  /**
   * Initializes the CollisionHandler.
  ...
  public static handleCollisions(shapes: VectorShape[], collisionCallback?: CollisionCallback): void {
    if (!CollisionHandler.octree) {
      console.error('CollisionHandler: Octree is not initialized. Call CollisionHandler.initialize() first.')
      return
    }
    const octree = CollisionHandler.octree
    ...
    shapes.forEach((shapeA) => {
      ...
      const nearbyShapes = octree.query({
